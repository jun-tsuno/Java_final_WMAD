...
public class SignUpController implements Initializable {
    ...
    public void SignUp(ActionEvent event) {
        ...
        if(this.username.getText().length() == 0 || this.password.getText().length() == 0 || this.confirmPassword.getText().length() == 0){
        ...
        if(isValid){
            ...
            this.signUpStatus.setText("Team member already exists");
        }
